...
public class Automation
    ...
    public void addGeneratorListener(GeneratorListener l) {
        assert (!generatorListeners.contains(l));
    ...
    public void run() {
        ...
        while ((currentIndex < genList.length) && (!quit)) {
            if (reloaded) {
            ...
            while ((currentTime < startTime + duration) && (!quit)) {
    ...
    public void addAutomationEditionListener(AutomationEditionListener l) {
        assert (!automationEditionListeners.contains(l));
    ...
    public boolean addAutomationExecutionListener(AutomationExecutionListener l) {
        if (automationExecutionListeners.addInstance(l)) {
    ...
    public boolean removeAutomationExecutionListener(AutomationExecutionListener l) {
        ...
        if (automationExecutionListeners.removeInstance(l)) {
    ...
    private String createOpenTag() {
        String tag = "<automation" + " name=\"" + uniqueName + "\"" +
                " step=\"" + stepDelay + "\"" +
                " loop=\"" + loop + "\"" +
                " init=\"" + initialValue + "\"" +
                ">\r\n";
